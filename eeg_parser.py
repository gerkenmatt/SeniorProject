...
def get_eeg_data():
	rootdir = '~/SeniorProject/EEG_Dataset/'
	num_patients = 5
	num_records = 14
	num_channels = 3
	sig_len = 640
	...
	for i in range(len(eeg_data)):
		# print "Data Array #" + str(i) + " shape: " + str(eeg_data[i].shape) + "; label : " + str(eeg_data_labels[i]) + "; sample: " + str(sample_nums[i])
		print "Data Array #" + str(i) + "; record: " +  str(record_nums[i])+ "; sample: " + str(sample_nums[i]) +  "; label : " + str(eeg_data_labels[i]) 
